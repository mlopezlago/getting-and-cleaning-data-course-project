  ...
  ## write the tidy dataset out to a txt & csv
  write.table(secondDataSetWithAverages, "./data/UCI HAR Dataset/smartphone-mean-and-standard-deviation-averages.txt", row.names = FALSE)
